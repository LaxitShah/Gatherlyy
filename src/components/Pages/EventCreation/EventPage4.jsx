  ...
  return (
    <div>
      ...
      <div className={styles.eve1}>
        ...
        <h1>
          Now describe what your community <br />
          will be about
        </h1>
        <h4>
          People will see this when we promote your community but you’ll be able to
          add to it later, too.
        </h4>
        <br />
        <div className={styles.eve3_list}>
          <p>1. What's the purpose of this community?</p>
          <br />
