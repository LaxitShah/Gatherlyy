...
export default function GroupAndEvent() {
  ...
  const staticEvents = [
    {
      _id: "static1",
      eventImage: image1,
      dateAndTime: "2023-12-25 18:00:00",
      title: "Climate Change Awareness Program",
      groupDetail: {
        groupName: "Change Makers",
      },
    },
    {
      _id: "static2",
      eventImage: image2,
      dateAndTime: "Open Mic Night",
      title: "",
      groupDetail: {
        groupName: "DAIICT",
      },
  ...
  const allEvents = [...staticEvents, ...data];
  ...
  return event.data !== undefined ? (
    ...
    <div>
            ...
            <div key={el._id} className={styles.eachContentBox}>
              ...
              >
                ...
                <div className={styles.eachContentBoxDetailDiv}>
                  ...
                  <div className={styles.attendiesDIv}>Number of attendies:400</div>
                </div>
              </div>
            </div>
          ))}
            ...
            <div key={el._id} className={styles.eachContentBox}>
              ...
              >
                ...
                <div className={styles.eachContentBoxDetailDiv}>
                  ...
                  <div className={styles.attendiesDIv}>Number of attendees:250</div>
                </div>
              </div>
            </div>
          ))}
      ...
      {/* Add static events rendering here */}
      <div className={styles.staticEventsSection}>
        <h2>Static Events</h2>
        {staticEvents.map((staticEvent) => (
          <div key={staticEvent._id} className={styles.eachContentBox}>
            <div className={styles.eachContentBoxDetailSection}>
              <div className={styles.eachContentBoxImage}>
                {/* Add a placeholder image for static events */}
                <img src={staticEvent.eventImage} alt="eventImage" />
              </div>
              <div className={styles.eachContentBoxDetailDiv}>
                <div className={styles.dateAndTime}>
                  {staticEvent.dateAndTime}
                </div>
                <h3 className={styles.clubName}>{staticEvent.title}</h3>
                <div className={styles.clubPlace}>
                  {staticEvent.groupDetail.groupName}
                </div>
                <div className={styles.attendiesDIv}>
                  Number of attendees (static)
                </div>
              </div>
            </div>
          </div>
